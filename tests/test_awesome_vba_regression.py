...
BASELINE: dict[str, tuple[int, str]] = {
    ...
    "stdVBA-master": (
        ...
        "ParamArray + Erase/ReDim member-chain and With-block leading-"
        "dot. Remaining ≈16 are deep analyzer cases (member-on-unknown-"
        "type, error-keyword-as-variable, Dim-inside-loop-scope, "
        "default-property Item) earmarked for vbatest Iter-5.",
    ),
}
